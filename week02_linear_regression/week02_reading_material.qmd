...
$$
E[\text{RSS}] = E[\boldsymbol{r}^T\boldsymbol{r}] = E[(\boldsymbol{I} - \boldsymbol{P})^T\boldsymbol{y}]^T[(\boldsymbol{I} - \boldsymbol{P})\boldsymbol{y}]]
$$
...
**F-statistic**:
$$
F = \frac{0.045/3}{0.005/96} = \frac{0.015}{0.000052} = 288.5
$$
